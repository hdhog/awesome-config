...
beautiful.init( config_dir .. "/zenburn.lua")
...
--reboot widget
    ...
    vicious.register(datewidget, vicious.widgets.date, '<span color="#ffffff"'..pango_small..">%b %d, %R</span>", 60)

 --Cpu widget 
  cpulabel= widget({ type = "textbox" })
  cpulabel.text='<span color="#ffffff" '..pango_small..' '..pango_bold..'>CPU: </span>'
...
--Cores Widgets
  ...
  corelabel.text='<span color="#ffffff"'..pango_small..">Cores:</span>"
...
-- Mem Widget
  ...
  --  memlabel.text='<span color="#fffff" '..pango_small..'>MEM: </span>'
...
--Mpd widgets
 ...
 --mpdlabel.text='<span color="#fffff" '..pango_small..'>MPD: </span>'
